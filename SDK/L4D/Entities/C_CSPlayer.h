...
public:
	...
	virtual bool		CanShowTeamMenu() const = 0;
...
public:
	...
	M_NETVAR(m_iPrimaryAddon, int, "CCSPlayer", "m_iPrimaryAddon");
	M_NETVAR(m_iSecondaryAddon, int, "CCSPlayer", "m_iSecondaryAddon");
	...
	M_NETVAR(m_iProgressBarDuration, int, "CCSPlayer", "m_iProgressBarDuration");
	M_NETVAR(m_flProgressBarStartTime, float, "CCSPlayer", "m_flProgressBarStartTime");
	M_NETVAR(m_progressBarText, const char*, "CCSPlayer", "m_progressBarText");
