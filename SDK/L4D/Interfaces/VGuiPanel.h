...
public:
	/*
	VPanelWrapper::SetMessageContextId(unsigned int,int)
	VPanelWrapper::GetMessageContextId(unsigned int)
	VPanelWrapper::SetSiblingPin(unsigned int,unsigned int,unsigned char,unsigned char)
	VPanelWrapper::Client(unsigned int)
	VPanelWrapper::GetModuleName(unsigned int)
	*/
};
